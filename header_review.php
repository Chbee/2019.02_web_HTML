...
<div id="menu_wrapper">
	...
	<ul>
		<li class="main_li">
			<div class="main" id="not_view"><a href="product.php" >PRODUCT</a></div>
			<!-- product의 서브메뉴 -->
			<div class="sub">
			<ul class="sub_menu">
		...
		<li class="main_li">
			<div class="main" id="view"><a href="review_menu.php">REVIEW</a></div>
			<!-- review의 서브메뉴 -->
			<div class="sub">
			<ul class="sub_menu">
				<li><a href="review_summary/summary_board.php">제품후기<a></li>
				<li><a href="">포토후기<a></li>
			</ul>
			</div>
		</li>
		...
		<li class="main_li">
			...
			<ul class="sub_menu">
				...
				<li><a href="free_board/free_board.php">자유게시판<a></li>
			</ul>
			</div>
		</li>
		...
		<li class="main_li">
			...
			<div class="sub">
			<ul class="sub_menu">
				<li><a href="https://www.doortodoor.co.kr/parcel/pa_004.jsp">CJ대한통운<a></li>
				<li><a href="https://service.epost.go.kr/iservice/usr/trace/usrtrc001k01.jsp">우체국택배<a></li>
			</ul>
			</div>
		</li>
